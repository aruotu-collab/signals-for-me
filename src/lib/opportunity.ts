...
export const BUSINESS_TYPES: BusinessType[] = [
  {
    ...
    valueBasis: "per year",
    lenses: [
      { key: "implant", label: "Implants", keywords: ["implant", "missing teeth", "tooth loss", "denture"], archetype: "demand" },
      { key: "invisalign", label: "Invisalign / ortho", keywords: ["invisalign", "orthodont", "aligner", "braces", "straighten"], archetype: "demand" },
      { key: "cosmetic", label: "Cosmetic & whitening", keywords: ["veneer", "whitening", "smile makeover", "composite bonding", "cosmetic dentistry"], archetype: "demand" },
      { key: "emergency", label: "Emergency dentistry", keywords: ["emergency dentist", "toothache", "dental pain", "same-day", "urgent dental"], archetype: "demand" },
      { key: "hygiene", label: "Hygiene & check-ups", keywords: ["hygiene", "check-up", "checkup", "scale and polish", "routine dental"], archetype: "demand" },
  ...
  },
  {
    ...
    lenses: [
      ...
      { key: "tax", label: "Tax & self-assessment", keywords: ["tax return", "self assessment", "self-assessment", "hmrc", "corporation tax", "tax relief", "r&d tax"], archetype: "demand" },
      { key: "payroll", label: "Payroll & bookkeeping", keywords: ["payroll", "bookkeeping", "paye", "auto-enrolment", "wages", "vat return"], archetype: "demand" },
      { key: "audit", label: "Audit & assurance", keywords: ["audit", "assurance", "statutory accounts", "year-end accounts"], archetype: "demand" },
      { key: "funded", label: "Funded businesses", keywords: ["funding", "raised", "investment", "seed", "series a", "series b", "grant"], archetype: "demand" },
      { key: "employer", label: "Hiring & payroll growth", keywords: ["hiring", "headcount", "staff", "jobs", "expansion"], archetype: "employer" },
  ...
  },
  {
    ...
    lenses: [
      ...
      { key: "lettings", label: "Lettings & rentals", keywords: ["letting", "rental", "to rent", "landlord", "tenant", "buy-to-let", "buy to let"], archetype: "new_resident" },
      { key: "commercial", label: "Commercial property", keywords: ["commercial property", "office space", "retail unit", "warehouse", "industrial unit"], archetype: "demand" },
      { key: "valuation", label: "Valuations & sales", keywords: ["valuation", "house price", "market appraisal", "asking price", "for sale"], archetype: "demand" },
      ...
      { key: "distress", label: "Forced & distressed sales", types: ["closure", "insolvency"], keywords: ["repossession", "probate", "divorce", "insolven", "downsiz"], archetype: "distress" },
  ...
  },
  {
    ...
    lenses: [
      ...
      { key: "permanent", label: "Permanent placements", keywords: ["permanent", "full-time", "perm role", "direct hire"], archetype: "employer" },
      { key: "temp", label: "Temp & contract staffing", keywords: ["temp", "temporary", "contract role", "interim", "fixed-term", "day rate"], archetype: "employer" },
      { key: "exec", label: "Executive search", keywords: ["executive search", "head of", "director", "c-suite", "chief", "ceo", "cfo", "cto"], archetype: "employer" },
  ...
  },
  {
    ...
    lenses: [
      ...
      { key: "seo", label: "SEO & content", keywords: ["seo", "search ranking", "organic traffic", "content marketing", "backlink"], archetype: "demand" },
      { key: "paid", label: "Paid ads / PPC", keywords: ["ppc", "google ads", "paid social", "ad spend", "advertising budget", "meta ads"], archetype: "demand" },
      { key: "social", label: "Social & creative", keywords: ["social media", "instagram", "tiktok", "creative", "influencer"], archetype: "demand" },
      { key: "web", label: "Web & brand", keywords: ["website", "web design", "landing page", "brand identity"], archetype: "demand" },
  ...
  },
  {
    ...
    lenses: [
      ...
      { key: "security", label: "Security & compliance", keywords: ["security", "soc 2", "gdpr", "compliance", "pen test", "cyber"], archetype: "demand" },
      { key: "integration", label: "Integrations & migration", keywords: ["integration", "crm migration", "erp", "api", "onboarding"], archetype: "demand" },
  ...
  },
  {
    ...
    benefitsFromDistress: true,
    lenses: [
      { key: "gold", label: "Gold & bullion", keywords: ["gold", "bullion", "precious metal"], archetype: "demand" },
      { key: "jewellery", label: "Jewellery & diamonds", keywords: ["jewellery", "jewelry", "diamond", "ring", "necklace", "bracelet", "engagement ring"], archetype: "demand" },
      { key: "watches", label: "Luxury watches", keywords: ["rolex", "omega", "watch", "luxury", "designer", "handbag"], archetype: "demand" },
      { key: "loans", label: "Pawn loans", keywords: ["pawn loan", "loan against", "short-term loan", "cash advance", "collateral", "payday"], archetype: "demand" },
      { key: "currency", label: "Currency exchange", keywords: ["currency", "foreign exchange", "travel money", "bureau de change", "euros", "dollars"], archetype: "demand" },
